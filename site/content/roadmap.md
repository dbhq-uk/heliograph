...
| GitLab CI | **do** | One file, against the pattern [pipelines](/pipelines) already establishes, loop guard included. GitLab is the git host of choice across a large part of the enterprise market |
