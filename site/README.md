...
Measured across all 29 pages, the same page costs three to twenty-one times
more bytes as HTML than as markdown - about seven times on the median page, six
