...
var Stations = []Station{
	...
	{ID: "schtask", Name: "Windows scheduled task", Short: "Windows task", Status: Proven, Flavour: "PowerShell",
		...
		Transports: map[string]Pairing{"git": yes(), "share": yes(), "blob": ok("through the bash station, not the PowerShell one"), "relay": needs("the PowerShell relay transport is not written yet - issue #77")}},
