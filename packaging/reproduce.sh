...
# =============================================================================
#     packaging/reproduce.sh v0.4.1             # into dist/
#     packaging/reproduce.sh v0.4.1 /tmp/out    # somewhere else
#
...
#    gh release download v0.4.1 -R heliograph-io/heliograph -p SHA256SUMS -O /tmp/published
...
tag="${1:?usage: reproduce.sh <tag, e.g. v0.4.1> [outdir]}"
